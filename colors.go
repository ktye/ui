...
func (w *Window) defaultColors() {
	w.Disabled = Colors{
		...
		Background: &image.Uniform{argb(0xf0f0f0ff)},
		Border:     argb(0xe0e0e0ff),
	}
	w.Inverse = Colors{
		Text:       argb(0xeeeeeeff),
		Background: &image.Uniform{argb(0x3272dcff)},
		Border:     argb(0x666666ff),
	}
	w.Selection = Colors{
		Text:       argb(0xeeeeeeff),
		Background: &image.Uniform{argb(0xbbbbbbff)},
		Border:     argb(0x666666ff),
	}
	...
	w.Placeholder = Colors{
		...
		Background: &image.Uniform{argb(0xf8f8f8ff)},
		Border:     argb(0xbbbbbbff),
	}
	w.Striped = Colors{
		Text:       argb(0x333333ff),
		Background: &image.Uniform{argb(0xf2f2f2ff)},
		Border:     argb(0xbbbbbbff),
	}
	...
	w.Regular = Colorset{
		...
		Hover: Colors{
			...
			Background: &image.Uniform{argb(0xfafafaff)},
	...
	w.Primary = Colorset{
		Normal: Colors{
			...
			Background: &image.Uniform{argb(0x007bffff)},
			Border:     argb(0x007bffff),
		},
		Hover: Colors{
			Text:       argb(0xffffffff),
			Background: &image.Uniform{argb(0x0062ccff)},
	...
	w.Secondary = Colorset{
		Normal: Colors{
			Text:       argb(0xffffffff),
			Background: &image.Uniform{argb(0x868e96ff)},
			Border:     argb(0x868e96ff),
		},
		Hover: Colors{
			Text:       argb(0xffffffff),
			Background: &image.Uniform{argb(0x727b84ff)},
	...
	w.Success = Colorset{
		Normal: Colors{
			Text:       argb(0xffffffff),
			Background: &image.Uniform{argb(0x28a745ff)},
			Border:     argb(0x28a745ff),
		},
		Hover: Colors{
			Text:       argb(0xffffffff),
			Background: &image.Uniform{argb(0x218838ff)},
	...
	w.Danger = Colorset{
		Normal: Colors{
			Text:       argb(0xffffffff),
			Background: &image.Uniform{argb(0xdc3545ff)},
			Border:     argb(0xdc3545ff),
		},
		Hover: Colors{
			Text:       argb(0xffffffff),
			Background: &image.Uniform{argb(0xc82333ff)},
			Border:     argb(0xbd2130ff),
		},
	}

	w.BackgroundColor = argb(0xfcfcfcff)
	w.Background = &image.Uniform{argb(0xfcfcfcff)}
