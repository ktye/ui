...
type Widget interface {
	...
	Draw(w *Window, self *Kid, img draw.Image, orig image.Point, m mouse.Event, force bool)
	...
	Mouse(w *Window, self *Kid, m mouse.Event, origM mouse.Event, orig image.Point) (r Result)
	...
	// `orig` is the origin location of this UI. If you want to warp the mouse, add the origin to the UI-relative point.
	Key(w *Window, self *Kid, k key.Event, m mouse.Event, orig image.Point) (r Result)
